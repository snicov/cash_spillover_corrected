/*
 * Filename: multiplier_wildboot_nominal.do
 * Description: This do file computes the full nominal multiplier and applies the wild bootstrap to obtain standard errors
 * Author: Tilman Graff
...
*global hhflowvar_inc
global hhstockvar_inc
global entflowvar_inc ent_profit2_wins ent_rentcost_wins ent_totaltaxes_wins
*global entflowvar_inc ent_wagebill_wins ent_profit2_wins ent_rentcost_wins ent_totaltaxes_wins
...
** Treated eligibles **
sum pac_ownvill [aweight=hhweight_EL] if eligible == 1 & treat == 1
global eligtreat_amt_ownvill = r(mean)

forval r = 2(2)20 {
	local r2 = `r' - 2
	sum pac_ov_`r2'to`r'km [aweight=hhweight_EL] if eligible == 1 & treat == 1
...
forval r = 2(2)20 {
	local r2 = `r' - 2
	sum pac_`r2'to`r'km [weight=hhweight_EL] if eligible == 1 & treat == 0
...
forval r = 2(2)20 {
	local r2 = `r' - 2
	sum pac_`r2'to`r'km [weight=hhweight_EL] if eligible == 0
	global inelig_amt_`r2'to`r'km = r(mean)
}

** treat, ent_type == 2 **
sum pac_ownvill [aweight=entweight_EL] if (treat == 1 & ent_type == 2)
global treatent2_amt_ownvill = r(mean)

forval r = 2(2)20 {
	local r2 = `r' - 2
	sum pac_ov_`r2'to`r'km [aweight=entweight_EL] if (treat == 1 & ent_type == 2)
	global treatent2_amt_ov_`r2'to`r'km = r(mean)

	sum pac_ov_`r2'to`r'km [aweight=entweight_EL] if (treat == 0 & ent_type == 2)
	global controlent2_amt_ov_`r2'to`r'km = r(mean)
}

** treat, ent_type == 1 **
sum pac_ownvill [aweight=entweight_EL] if (treat == 1 & ent_type == 1)
global treatent1_amt_ownvill = r(mean)

forval r = 2(2)20 {
	local r2 = `r' - 2
	sum pac_ov_`r2'to`r'km [aweight=entweight_EL] if (treat == 1 & ent_type == 1)
	global treatent1_amt_ov_`r2'to`r'km = r(mean)

	sum pac_ov_`r2'to`r'km [aweight=entweight_EL] if (treat == 0 & ent_type == 1)
	global controlent1_amt_ov_`r2'to`r'km = r(mean)
}

** treat, ent_type == 3 **
sum pac_ownvill [aweight=entweight_EL] if (treat == 1 & ent_type == 3)
global treatent3_amt_ownvill = r(mean)

forval r = 2(2)20 {
	local r2 = `r' - 2
	sum pac_ov_`r2'to`r'km [aweight=entweight_EL] if (treat == 1 & ent_type == 3)
	global treatent3_amt_ov_`r2'to`r'km = r(mean)

	sum pac_ov_`r2'to`r'km [aweight=entweight_EL] if (treat == 0 & ent_type == 3)
		...
		if "${hhstockvar_`type'} ${hhflowvar_`type'}" != " " {
			foreach v of var ${hhstockvar_`type'} ${hhflowvar_`type'} {
				...
				** i. treated households **
				...
				forval r = 2(2)20 {
					local r2 = `r' - 2
					ivreg2 `v' (pac_ownvill pac_ov_0to2km-pac_ov_`r2'to`r'km = treat share_ge_elig_treat_ov_0to2km-share_ge_elig_treat_ov_`r2'to`r'km) `blvars' [aweight=hhweight_EL] if eligible == 1
					estat ic
				...
				** ii. untreated households **
				...
				forval r = 2(2)20 {
					local r2 = `r' - 2
					local endregs = "`endregs'" + " c.pac_`r2'to`r'km#eligible"
		...
		**************************
		if "${entstockvar_`type'} ${entflowvar_`type'}" != " " {
			foreach v of var ${entstockvar_`type'} ${entflowvar_`type'} {
				...
				local endregs = "c.pac_ownvill#ent_type"
				local exregs = "treat#ent_type"
				forval r = 2(2)20 {
					local r2 = `r' - 2
					local endregs = "`endregs'" + " c.pac_ov_`r2'to`r'km#ent_type"
...
if "${hhflowvar_`type'}" != "" {
	foreach v of var ${hhflowvar_`type'} {
		...
		** add all buffer variables **
		local endregs = "pac_ownvill_q1-pac_ownvill_q10"
		local exregs = "t_share_actamt_ownvill_q1-t_share_actamt_ownvill_q10"
		forval r = 2(2)`rad' {
			local r2 = `r' - 2

			local endregs = "`endregs'" + " pac_ov_`r2'to`r'km_q1-pac_ov_`r2'to`r'km_q10"
			local exregs = "`exregs'" + " t_share_actamt_ov_`r2'to`r'km_q1-t_share_actamt_ov_`r2'to`r'km_q10"
		}

		ivreg2 `v' (`endregs' = `exregs') ibn.quarter `blvars' [aweight=hhweight_EL] if eligible == 1, nocons
		*ivreg2 `v' (pac_ownvill_q1-pac_ownvill_q10 pac_ov_0to2km_q1-pac_ov_0to2km_q10 = t_share_actamt_ownvill_q1-t_share_actamt_ownvill_q10 t_share_actamt_ov_0to2km_q1-t_share_actamt_ov_0to2km_q10) ibn.quarter [aweight=hhweight_EL] if eligible == 1, nocons
		...
		forval q = $firstquarter(1)10 {
			...
			if `q' < 3 {
				local irfstat = "(pac_ownvill_q`lag1'*$eligtreat_amt_ownvill)*(47/87)"
				local intstat = "`intstat'"  + " + (pac_ownvill_q`lag1'*$eligtreat_amt_ownvill)*(47/87)"

				forval r = 2(2)`rad' {
					local r2 = `r' - 2
					local intstat = "`intstat'"  + " + pac_ov_`r2'to`r'km_q`lag1'*${eligtreat_amt_ov_`r2'to`r'km} *(47/87)"
					local irfstat = "`irfstat'"  + " + pac_ov_`r2'to`r'km_q`lag1'*${eligtreat_amt_ov_`r2'to`r'km} *(47/87)"
				}
			}

			else {
				local irfstat = "(pac_ownvill_q`lag1'*$eligtreat_amt_ownvill)*(47/87) + (pac_ownvill_q`lag2'*$eligtreat_amt_ownvill)*(40/87)"
				local intstat = "`intstat'"  + " + (pac_ownvill_q`lag1'*$eligtreat_amt_ownvill)*(47/87) + (pac_ownvill_q`lag2'*$eligtreat_amt_ownvill)*(40/87)"

				forval r = 2(2)`rad' {
					local r2 = `r' - 2
					local intstat = "`intstat'"  + " + (pac_ov_`r2'to`r'km_q`lag1'*${eligtreat_amt_ov_`r2'to`r'km})*(47/87) + (pac_ov_`r2'to`r'km_q`lag2'*${eligtreat_amt_ov_`r2'to`r'km})*(40/87)"
					local irfstat = "`irfstat'"  + " + (pac_ov_`r2'to`r'km_q`lag1'*${eligtreat_amt_ov_`r2'to`r'km})*(47/87) + (pac_ov_`r2'to`r'km_q`lag2'*${eligtreat_amt_ov_`r2'to`r'km})*(40/87)"
		...
		**********
		...
		if `plotindic' == 1 graph export "$dfig/IRFs/HHS/`v'_Treated.pdf", as(pdf) replace
		...
		** Total consumption integral **
		...
		if $firstquarter == 1 mat2txt, m(effectstreat) sav("$dt/IRF_values/treated/`v'_IRF_treat.txt") replace
		project, creates("$dt/IRF_values/treated/`v'_IRF_treat.txt") preserve
		...
		** add all buffer variables **
		...
		forval r = 2(2)`rad' {
			...
			local endregs = "`endregs'" + "pac_`r2'to`r'km_el_q1-pac_`r2'to`r'km_el_q10 pac_`r2'to`r'km_in_q1-pac_`r2'to`r'km_in_q10"
			local exregs = "`exregs'" + "t_shr_actamt_`r2'to`r'km_el_q1-t_shr_actamt_`r2'to`r'km_el_q10 t_shr_actamt_`r2'to`r'km_in_q1-t_shr_actamt_`r2'to`r'km_in_q10"
		}

		ivreg2 `v' (`endregs' = `exregs') ibn.quarter#i.eligible `blvars_untreat' [aweight=hhweight_EL] if (eligible == 0 | treat == 0), nocons
		*ivreg2 `v' (pac_0to2km_el_q1-pac_0to2km_el_q10 pac_0to2km_in_q1-pac_0to2km_in_q10 = t_shr_actamt_0to2km_el_q1-t_shr_actamt_0to2km_el_q10 t_shr_actamt_0to2km_in_q1-t_shr_actamt_0to2km_in_q10) ibn.quarter#i.eligible [aweight=hhweight_EL] if (eligible == 0 | treat == 0), nocons
		...
		forval q = $firstquarter(1)10 {
			...
			if `q' < 3 {
				forval r = 2(2)`rad' {
					local r2 = `r' - 2
					local intstat = "`intstat'"  + " + (pac_`r2'to`r'km_el_q`lag1'*${eligcontrol_amt_`r2'to`r'km}*$eligcontrolweight + pac_`r2'to`r'km_in_q`lag1'*${inelig_amt_`r2'to`r'km}*$ineligweight)*(47/87)"
					local irfstat = "(pac_`r2'to`r'km_el_q`lag1'*${eligcontrol_amt_`r2'to`r'km}*$eligcontrolweight + pac_`r2'to`r'km_in_q`lag1'*${inelig_amt_`r2'to`r'km}*$ineligweight)*(47/87)"
				...
				forval r = 2(2)`rad' {
					local r2 = `r' - 2
					local intstat = "`intstat'"  + " + (pac_`r2'to`r'km_el_q`lag1'*${eligcontrol_amt_`r2'to`r'km}*$eligcontrolweight + pac_`r2'to`r'km_in_q`lag1'*${inelig_amt_`r2'to`r'km}*$ineligweight)*(47/87) + (pac_`r2'to`r'km_el_q`lag2'*${eligcontrol_amt_`r2'to`r'km}*$eligcontrolweight + pac_`r2'to`r'km_in_q`lag2'*${inelig_amt_`r2'to`r'km}*$ineligweight)*(40/87)"
					local irfstat = "(pac_`r2'to`r'km_el_q`lag1'*${eligcontrol_amt_`r2'to`r'km}*$eligcontrolweight + pac_`r2'to`r'km_in_q`lag1'*${inelig_amt_`r2'to`r'km}*$ineligweight)*(47/87) + (pac_`r2'to`r'km_el_q`lag2'*${eligcontrol_amt_`r2'to`r'km}*$eligcontrolweight + pac_`r2'to`r'km_in_q`lag2'*${inelig_amt_`r2'to`r'km}*$ineligweight)*(40/87)"
				}
			}
		...
		**********
		...
		if `plotindic' == 1 graph export "$dfig/IRFs/HHs/`v'_Untreated.pdf", as(pdf) replace

		mata: effectsuntreat = effects

		mata: st_matrix("effectsuntreat",effectsuntreat*$untreatweight)
		if $firstquarter == 1 mat2txt, m(effectsuntreat) sav("$dt/IRF_values/untreated/`v'_IRF_untreat.txt") replace
		project, creates("$dt/IRF_values/untreated/`v'_IRF_untreat.txt") preserve
		...
		** Export joint IRF for epic graph **
		...
		if $firstquarter == 1 mat2txt, m(jointeffects) sav("$dt/IRF_values/joint/`v'_IRF_joint.txt") replace
		project, creates("$dt/IRF_values/joint/`v'_IRF_joint.txt") preserve
	}
}
...
if "${hhstockvar_`type'}" != "" {
	foreach v of var ${hhstockvar_`type'} {
		...
		***************************
		...
		ivreg2 `v' (pac_ownvill pac_ov_0to2km-pac_ov_`rad2'to`rad'km = treat share_ge_elig_treat_ov_0to2km-share_ge_elig_treat_ov_`rad2'to`rad'km) `blvars' [aweight=hhweight_EL] if eligible == 1, cluster(sublocation_code)
		...
		** Get mean total effect on treated eligibles **
		local ATEstring_tot = "$eligtreat_amt_ownvill" + "*pac_ownvill"

		forval r = 2(2)`rad' {
			local r2 = `r' - 2
			local ATEstring_tot = "`ATEstring_tot'" + "+" + "${eligtreat_amt_ov_`r2'to`r'km}" + "*" + "pac_ov_`r2'to`r'km"
		}
		...
		******************************
		...
		forval r = 2(2)`rad' {
			...
			local endregs = "`endregs'" + " pac_`r2'to`r'km_eligible" + " pac_`r2'to`r'km_ineligible"
		...
		** Get mean total spillover effect on eligibles in control villages and ineligibles **
		...
		forval r = 2(2)`rad' {
			local r2 = `r' - 2
			local ATEstring_spillover = "`ATEstring_spillover'" + "+" + "$eligcontrolweight" + "*${eligcontrol_amt_`r2'to`r'km}" + "*pac_`r2'to`r'km_eligible"
			local ATEstring_spillover = "`ATEstring_spillover'" + "+" + "$ineligweight" + "*${inelig_amt_`r2'to`r'km}" + "*pac_`r2'to`r'km_ineligible"
		}
...
if "${entflowvar_`type'}" != "" {
	foreach v of var ${entflowvar_`type'} {
		...
		** add all buffer variables **
		...
		local exregs ""
		forval q = 1(1)10 {
			local endregs = "`endregs'" + " c.pac_ownvill_q`q'#ent_type"
			local exregs = "`exregs'" + " c.t_share_actamt_ownvill_q`q'#ent_type"

			forval r = 2(2)`rad' {
				local r2 = `r' - 2
				local endregs = "`endregs'" + " c.pac_ov_`r2'to`r'km_q`q'#ent_type"
				local exregs = "`exregs'" + " c.t_share_actamt_ov_`r2'to`r'km_q`q'#ent_type"
			}
		}
		...
		** Column 3: Rescale by number of enterprises in control villages / number of households in control villages -- this assumes all profits/revenues stay within the village **
		...
		forval q = $firstquarter(1)10 {
			...
			if `q' < 3 {
				*local intstat_total = "`intstat_total'"  + " + $treatent2_amt_ownvill" + "*2.ent_type#c.pac_ownvill_q`lag1' * $n_ent_from_hh_treatall / $n_hh_treatall * (47/87)"
				*local intstat_total = "`intstat_total'" + " + $treatent1_amt_ownvill" + "*1.ent_type#c.pac_ownvill_q`lag1' * $n_ent_outside_hh_treatall / $n_hh_treatall * (47/87)"

				local irfstat_total = "$treatent2_amt_ownvill" + "*2.ent_type#c.pac_ownvill_q`lag1' * $n_ent_from_hh_treatall / $n_hh_treatall * (47/87)"
				local irfstat_total = "`irfstat_total'" + " + $treatent1_amt_ownvill" + "*1.ent_type#c.pac_ownvill_q`lag1' * $n_ent_outside_hh_treatall / $n_hh_treatall * (47/87)"


				sum `v' if ent_type == 3
				if r(N) != 0 {  // we don't have this information for agricultural businesses
					*local intstat_total = "`intstat_total'" + " + $treatent3_amt_ownvill" + "*3.ent_type#c.pac_ownvill_q`lag1' * $n_ent_ownfarm_treatall / $n_hh_treatall * (47/87)"
					local irfstat_total = "`irfstat_total'" + " + $treatent3_amt_ownvill" + "*3.ent_type#c.pac_ownvill_q`lag1' * $n_ent_ownfarm_treatall / $n_hh_treatall * (47/87)"
				}

				forval r = 2(2)`rad' {
					local r2 = `r' - 2

					*local intstat_total = "`intstat_total'" + "+ ${treatent2_amt_ov_`r2'to`r'km}" + "*2.ent_type#c.pac_ov_`r2'to`r'km_q`lag1' * $n_ent_from_hh_treatall / $n_hh_treatall *(47/87)"
					*local intstat_spillover = "`intstat_spillover'" + "+" + "${controlent2_amt_ov_`r2'to`r'km}" + "*2.ent_type#c.pac_ov_`r2'to`r'km_q`lag1' * $n_ent_from_hh_control / $n_hh_controlall * (47/87)"

					*local intstat_total = "`intstat_total'" + "+ ${treatent1_amt_ov_`r2'to`r'km}" + "*1.ent_type#c.pac_ov_`r2'to`r'km_q`lag1' * $n_ent_outside_hh_treatall / $n_hh_treatall *(47/87)"
					*local intstat_spillover = "`intstat_spillover'" + "+" + "${controlent1_amt_ov_`r2'to`r'km}" + "*1.ent_type#c.pac_ov_`r2'to`r'km_q`lag1' * $n_ent_outside_hh_control / $n_hh_controlall * (47/87)"

					local irfstat_total = "`irfstat_total'" + "+ ${treatent2_amt_ov_`r2'to`r'km}" + "*2.ent_type#c.pac_ov_`r2'to`r'km_q`lag1' * $n_ent_from_hh_treatall / $n_hh_treatall *(47/87)" + "+ ${treatent1_amt_ov_`r2'to`r'km}" + "*1.ent_type#c.pac_ov_`r2'to`r'km_q`lag1' * $n_ent_outside_hh_treatall / $n_hh_treatall *(47/87)"
					local irfstat_spillover = "${controlent2_amt_ov_`r2'to`r'km}" + "*2.ent_type#c.pac_ov_`r2'to`r'km_q`lag1' * $n_ent_from_hh_control / $n_hh_controlall * (47/87)"  + "+" + "${controlent1_amt_ov_`r2'to`r'km}" + "*1.ent_type#c.pac_ov_`r2'to`r'km_q`lag1' * $n_ent_outside_hh_control / $n_hh_controlall * (47/87)"

					sum `v' if ent_type == 3
					if r(N) != 0 {  // we don't have this information for agricultural businesses
						*local intstat_total = "`intstat_total'" + "+ ${treatent3_amt_ov_`r2'to`r'km}" + "*3.ent_type#c.pac_ov_`r2'to`r'km_q`lag1' * $n_ent_ownfarm_treatall / $n_hh_treatall *(47/87)"
						*local intstat_spillover = "`intstat_spillover'" + "+" + "${controlent3_amt_ov_`r2'to`r'km}" + "*3.ent_type#c.pac_ov_`r2'to`r'km_q`lag1' * $n_ent_ownfarm_control / $n_hh_controlall * (47/87)"

						local irfstat_total = "`irfstat_total'" + "+ ${treatent3_amt_ov_`r2'to`r'km}" + "*3.ent_type#c.pac_ov_`r2'to`r'km_q`lag1' * $n_ent_ownfarm_treatall / $n_hh_treatall *(47/87)"
						local irfstat_spillover = "`irfstat_spillover'" + "+" + "${controlent3_amt_ov_`r2'to`r'km}" + "*3.ent_type#c.pac_ov_`r2'to`r'km_q`lag1' * $n_ent_ownfarm_control / $n_hh_controlall * (47/87)"
					}
				}
			}

			else {
				*local intstat_total = "`intstat_total'"  + " + $treatent2_amt_ownvill" + "*(2.ent_type#c.pac_ownvill_q`lag1' * (47/87) + 2.ent_type#c.pac_ownvill_q`lag2' * (40/87)) * $n_ent_from_hh_treatall / $n_hh_treatall"
				*local intstat_total = "`intstat_total'" + " + $treatent1_amt_ownvill" + "*(1.ent_type#c.pac_ownvill_q`lag1' * (47/87) + 1.ent_type#c.pac_ownvill_q`lag2' * (40/87)) * $n_ent_outside_hh_treatall / $n_hh_treatall"

				local irfstat_total = "$treatent2_amt_ownvill" + "*(2.ent_type#c.pac_ownvill_q`lag1' * (47/87) + 2.ent_type#c.pac_ownvill_q`lag2' * (40/87)) * $n_ent_from_hh_treatall / $n_hh_treatall"
				local irfstat_total = "`irfstat_total'" + " + $treatent1_amt_ownvill" + "*(1.ent_type#c.pac_ownvill_q`lag1' * (47/87) + 1.ent_type#c.pac_ownvill_q`lag2' * (40/87)) * $n_ent_outside_hh_treatall / $n_hh_treatall"

				sum `v' if ent_type == 3
				if r(N) != 0 {  // we don't have this information for agricultural businesses
					*local intstat_total = "`intstat_total'" + " + $treatent3_amt_ownvill" + "*(3.ent_type#c.pac_ownvill_q`lag1' * (47/87) + 3.ent_type#c.pac_ownvill_q`lag2' * (40/87))* $n_ent_ownfarm_treatall / $n_hh_treatall"
					local irfstat_total = "`irfstat_total'" + " + $treatent3_amt_ownvill" + "*(3.ent_type#c.pac_ownvill_q`lag1' * (47/87) + 3.ent_type#c.pac_ownvill_q`lag2' * (40/87))* $n_ent_ownfarm_treatall / $n_hh_treatall"
				}

				forval r = 2(2)`rad' {
					local r2 = `r' - 2

					*local intstat_total = "`intstat_total'" + "+ ${treatent2_amt_ov_`r2'to`r'km}" + "*(2.ent_type#c.pac_ov_`r2'to`r'km_q`lag1' * (47/87) +  2.ent_type#c.pac_ov_`r2'to`r'km_q`lag2' * (40/87)) * $n_ent_from_hh_treatall / $n_hh_treatall"
					*local intstat_spillover = "`intstat_spillover'" + "+" + "${controlent2_amt_ov_`r2'to`r'km}" + "*(2.ent_type#c.pac_ov_`r2'to`r'km_q`lag1' * (47/87) + 2.ent_type#c.pac_ov_`r2'to`r'km_q`lag2' * (40/87)) * $n_ent_from_hh_control / $n_hh_controlall"

					*local intstat_total = "`intstat_total'" + "+ ${treatent1_amt_ov_`r2'to`r'km}" + "*(1.ent_type#c.pac_ov_`r2'to`r'km_q`lag1' * (47/87) +  1.ent_type#c.pac_ov_`r2'to`r'km_q`lag2' * (40/87)) * $n_ent_outside_hh_treatall / $n_hh_treatall"
					*local intstat_spillover = "`intstat_spillover'" + "+" + "${controlent1_amt_ov_`r2'to`r'km}" + "*(1.ent_type#c.pac_ov_`r2'to`r'km_q`lag1' * (47/87) + 1.ent_type#c.pac_ov_`r2'to`r'km_q`lag2' * (40/87)) * $n_ent_outside_hh_control / $n_hh_controlall"

					local irfstat_total = "`irfstat_total'" + "+ ${treatent2_amt_ov_`r2'to`r'km}" + "*(2.ent_type#c.pac_ov_`r2'to`r'km_q`lag1' * (47/87) +  2.ent_type#c.pac_ov_`r2'to`r'km_q`lag2' * (40/87)) * $n_ent_from_hh_treatall / $n_hh_treatall"
					local irfstat_spillover = "${controlent2_amt_ov_`r2'to`r'km}" + "*(2.ent_type#c.pac_ov_`r2'to`r'km_q`lag1' * (47/87) + 2.ent_type#c.pac_ov_`r2'to`r'km_q`lag2' * (40/87)) * $n_ent_from_hh_control / $n_hh_controlall"

					local irfstat_total = "`irfstat_total'" + "+ ${treatent1_amt_ov_`r2'to`r'km}" + "*(1.ent_type#c.pac_ov_`r2'to`r'km_q`lag1' * (47/87) +  1.ent_type#c.pac_ov_`r2'to`r'km_q`lag2' * (40/87)) * $n_ent_outside_hh_treatall / $n_hh_treatall"
					local irfstat_spillover = "`irfstat_spillover'" + "+" + "${controlent1_amt_ov_`r2'to`r'km}" + "*(1.ent_type#c.pac_ov_`r2'to`r'km_q`lag1' * (47/87) + 1.ent_type#c.pac_ov_`r2'to`r'km_q`lag2' * (40/87)) * $n_ent_outside_hh_control / $n_hh_controlall"


					sum `v' if ent_type == 3
					if r(N) != 0 {  // we don't have this information for agricultural businesses
						*local intstat_total = "`intstat_total'" + "+ ${treatent3_amt_ov_`r2'to`r'km}" + "*(3.ent_type#c.pac_ov_`r2'to`r'km_q`lag1' * (47/87) +  3.ent_type#c.pac_ov_`r2'to`r'km_q`lag2' * (40/87)) * $n_ent_ownfarm_treatall / $n_hh_treatall"
						*local intstat_spillover = "`intstat_spillover'" + "+" + "${controlent3_amt_ov_`r2'to`r'km}" + "*(3.ent_type#c.pac_ov_`r2'to`r'km_q`lag1' * (47/87) + 3.ent_type#c.pac_ov_`r2'to`r'km_q`lag2' * (40/87)) * $n_ent_ownfarm_control / $n_hh_controlall"

						local irfstat_total = "`irfstat_total'" + "+ ${treatent3_amt_ov_`r2'to`r'km}" + "*(3.ent_type#c.pac_ov_`r2'to`r'km_q`lag1' * (47/87) +  3.ent_type#c.pac_ov_`r2'to`r'km_q`lag2' * (40/87)) * $n_ent_ownfarm_treatall / $n_hh_treatall"
						local irfstat_spillover = "`irfstat_spillover'" + "+" + "${controlent3_amt_ov_`r2'to`r'km}" + "*(3.ent_type#c.pac_ov_`r2'to`r'km_q`lag1' * (47/87) + 3.ent_type#c.pac_ov_`r2'to`r'km_q`lag2' * (40/87)) * $n_ent_ownfarm_control / $n_hh_controlall"
					}
				}
			}
		...
		**********
		...
		if `plotindic' == 1 graph export "$dfig/IRFs/ENTs/`v'_TreatedVills.pdf", as(pdf) replace

		mata: st_matrix("effects_total",effects_total*$n_hh_treatall / $n_hh_treat)
		if $firstquarter == 1 mat2txt, m(effects_total) sav("$dt/IRF_values/treated/`v'_IRF_total.txt") replace
		project, creates("$dt/IRF_values/treated/`v'_IRF_total.txt") preserve
		...
		**********
		...
		if `plotindic' == 1 graph export "$dfig/IRFs/ENTs/`v'_UntreatedVills.pdf", as(pdf) replace

		mata: st_matrix("effects_spillover",effects_spillover*$n_hh_controlall / $n_hh_treat)
		if $firstquarter == 1 mat2txt, m(effects_spillover) sav("$dt/IRF_values/untreated/`v'_IRF_spillover.txt") replace
		project, creates("$dt/IRF_values/untreated/`v'_IRF_spillover.txt") preserve
...
if "${entstockvar_`type'}" != "" {
	foreach v of var ${entstockvar_`type'} {
		...
		** Column 3: Rescale by number of enterprises in control villages / number of households in control villages -- this assumes all profits/revenues stay within the village **
		...
		local ATEstring_total = "$treatent2_amt_ownvill" + "*2.ent_type#c.pac_ownvill * $n_ent_from_hh_treatall / $n_hh_treatall"
		local ATEstring_total = "`ATEstring_total'" + "+" + "$treatent1_amt_ownvill" + "*1.ent_type#c.pac_ownvill * $n_ent_outside_hh_treatall / $n_hh_treatall"

		sum `v' if ent_type == 3
		if r(N) != 0 {  // we don't have this information for agricultural businesses
			local ATEstring_total = "`ATEstring_total'" + "+" + "$treatent3_amt_ownvill" + "*3.ent_type#c.pac_ownvill * $n_ent_ownfarm_treatall / $n_hh_treatall"
		}
		...
		forval r = 2(2)`rad' {
			...
			local ATEstring_total = "`ATEstring_total'" + "+" + "${treatent2_amt_ov_`r2'to`r'km}" + "*2.ent_type#c.pac_ov_`r2'to`r'km * $n_ent_from_hh_treatall / $n_hh_treatall"
			local ATEstring_spillover = "`ATEstring_spillover'" + "+" + "${controlent2_amt_ov_`r2'to`r'km}" + "*2.ent_type#c.pac_ov_`r2'to`r'km * $n_ent_from_hh_control / $n_hh_controlall"

			local ATEstring_total = "`ATEstring_total'" + "+" + "${treatent1_amt_ov_`r2'to`r'km}" + "*1.ent_type#c.pac_ov_`r2'to`r'km * $n_ent_outside_hh_treatall / $n_hh_treatall"
			local ATEstring_spillover = "`ATEstring_spillover'" + "+" + "${controlent1_amt_ov_`r2'to`r'km}" + "*1.ent_type#c.pac_ov_`r2'to`r'km * $n_ent_outside_hh_control / $n_hh_controlall"

			sum `v' if ent_type == 3
			if r(N) != 0 {  // we don't have this information for agricultural businesses
				local ATEstring_total = "`ATEstring_total'" + "+" + "${treatent3_amt_ov_`r2'to`r'km}" + "*3.ent_type#c.pac_ov_`r2'to`r'km * $n_ent_ownfarm_treatall / $n_hh_treatall"
				local ATEstring_spillover = "`ATEstring_spillover'" + "+" + "${controlent3_amt_ov_`r2'to`r'km}" + "*3.ent_type#c.pac_ov_`r2'to`r'km * $n_ent_ownfarm_control / $n_hh_controlall"
			}
		}
	...
	if "${hhstockvar_`type'}" != "" {
		foreach v of var ${hhstockvar_`type'} {
			...
			***************************
			...
			cap drop p_`v'
			gen p_`v' = ht_`v' + et_`v'*rand if st_`v'
			ivreg2 p_`v' (pac_ownvill pac_ov_0to2km-pac_ov_`rad2'to`rad'km = treat share_ge_elig_treat_ov_0to2km-share_ge_elig_treat_ov_`rad2'to`rad'km) `blvars' [aweight=hhweight_EL] if eligible == 1
...
di "Simulation string: `simulationstring'"
loc str_length = length("`simulationstring'")
di "String length: `str_length'"
...
save "$dt/IRF_values/bootstrap_rawoutput`quartername'.dta", replace
project, creates("$dt/IRF_values/bootstrap_rawoutput`quartername'.dta") preserve
